...
import wx
from cluePackage.deck import clueDeck
	...
	def on_standard(self, e):
		...
		if   clickedButton == self.btnWeapon:
			...
			self.deck.add_category("Room",\
				["Hall", "Ball Room", "Billiard Room", "Lounge",\
				"Library", "Conservatory", "Kitchen", "Dining Room", "Study"])
